...
For continuous features, you will have the option of having 2 groups or 3 groups of samples. For 2 groups, we divide the samples on the median. For 3 groups, we divide samples into the upper third, middle third, and lower third. 

If more than one sample has the same value, we put them in a group together, even if this means the groups end up being somewhat unequal in size.
